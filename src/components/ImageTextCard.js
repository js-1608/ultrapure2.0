  ...
  return (
    <div className="flex flex-col md:flex-row items-center bg-white  overflow-hidden ">
      ...
      <div className="w-full md:w-1/2 p-8">
        ...
        <p className="text-gray-700 text-base md:text-md text-justify">Ultrapure utilizes innovative technologies in their air purifier to provide mose effective and efficient purification solutions. These technologies have been tested and certified by various labs, ensuring the highest quality air purification.</p>
        <h2 className="text-2xl md:text-2xl font-bold mb-1 mt-6 ">Advanced Filtration Systems</h2>
        <p className="text-gray-700 text-base md:text-md text-justify">
