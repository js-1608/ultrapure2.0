...
export default function HomePage() {
  return (
    ...
    <div className="relative  ">
          <img src={COUNT} alt="Card image" className="w-full h-full object-cover opacity-100" />
      ...
      <div className='text-center m-5'>
        ...
        <h2 className=' font-bold text-5xl'>Why Choose <span className='text-textBlue'>Ultrapure</span></h2>
        <p className='max-w-4xl text-center m-auto font-normal mt-10'>We stand out as a 'Need-based Manufacturer,' focusing on client-specific solutions, which has built our strong reputation and loyal customer base. With offices in Delhi, Mumbai, and Bengaluru, we effectively serve clients nationwide.</p>
      </div>
      ...
      <div className=' flex justify-center mb-2'>
        <button className="mt-5 inline-flex items-center px-4 py-2 bg-ultragreen  text-white rounded hover:bg-gray-200 font-medium  text-center m-1">Learn More<FaArrowRight className="ml-2" /></button>
        <button className="mt-5 inline-flex items-center px-4 py-2 rounded hover:bg-gray-200 font-medium  text-center m-1">Contact us<FaArrowRight className="ml-2" /></button>
