...
function Covid() {
	...
	const faqs = [
		...
		},
		{
			...
			answer: {
				type: "list",
				items: ["Eliminates viruses and bacteria using UV-light and Advanced Oxidation Processes (AOP).",
                   " Provides comprehensive air purification with a multi-stage filtration system.",
                    "Prevents airborne transmission of particles, VOCs, and odors.",
                    "Improves indoor air quality by continuously purifying incoming fresh air.",
                  "Reduces the risk of airborne infections, promoting a healthier environment.",
                "Operates with minimal energy consumption for efficient air purification.",
                 "Ensures long-lasting performance with durable, low-maintenance filters.",
                   " Utilizes patented filtration technology for superior air protection.",
                  " Effectively removes odors to maintain a pleasant indoor atmosphere.",
                   "Offers versatile use, compatible with various HVAC systems and environments."]
			}
		},
		{
			id: 3,
		...
		<div>
			...
			<div className="flex flex-col md:flex-row  p-4 md:p-8 rounded-lg">
				...
				<h1 className="lg:text-2xl  text-xl font-bold mt-2">Product Info</h1>
                    ...
                    However, formaNOX is ideal for removing toxic gases and eliminating odours from the air. It purifies the air inside the mortuary and autopsy room through the process of oxidation and chemisorption.
                    </p>
                    </div>
						...
						{openFAQ === faq.id && (
							<div className="p-4 bg-gray-100 rounded-lg">
								...
								{faq.answer.type === "words" && (
									<div className="gap-2 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4">
