      ...
      <div className="flex flex-wrap ">
        <div className="flex-1 p-2 w-4/5">
          ...
          <section id="Airports " className=" border rounded shadow-lg m-5 mb-16">
            <h1 className='text-2xl lg:text-2xl  ml-5 lg:ml-10 mt-5  font-bold '>Airport</h1>
          ...
          <section id="Museums" className=" border rounded shadow-lg m-5 mb-16">
            <h1 className='text-2xl lg:text-2xl  ml-5 lg:ml-10 mt-5 font-bold '>Museums</h1>
            <div className="container mx-auto p-4">
          ...
          <section id="Schools"className=" border rounded shadow-lg m-5 mb-16">
            <h1 className='text-2xl lg:text-4xl  ml-5 lg:ml-10 mt-5 font-bold '>Schools & Universities</h1>
            <div className="container mx-auto p-4 ">
          ...
          <section id="Restaurants"className=" border rounded shadow-lg m-5 mb-16">
            <h1 className='text-2xl lg:text-4xl  ml-5 lg:ml-10 mt-5 font-bold '>	Restaurants</h1>
            <div className="container mx-auto p-4">
          ...
          <section id="Offices" className=" border rounded shadow-lg m-5 mb-16">
            <h1 className='text-2xl lg:text-4xl  ml-5 lg:ml-10 mt-5 font-bold '>Offices</h1>
            <div className="container mx-auto p-4">
          ...
          <section id="Hotels" className=" border rounded shadow-lg m-5 mb-16">
            <h1 className='text-2xl lg:text-4xl  ml-5 lg:ml-10 mt-5 font-bold '>Hotels</h1>
            <div className="container mx-auto p-4 ">
          ...
          <section id="Halls" className=" border rounded shadow-lg m-5 mb-16">
            <h1 className='text-2xl lg:text-4xl  ml-5 lg:ml-10 mt-5 font-bold '>	Halls & Malls</h1>
            <div className="container mx-auto p-4">
