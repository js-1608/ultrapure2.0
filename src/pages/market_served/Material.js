    ...
    <div>
      ...
      <div className="flex flex-wrap ">
        <div className="flex-1 p-2 w-4/5">
          {/*Mining*/}
          <section id="Mining" className=" border rounded shadow-lg m-5">
            <h1 className='text-4xl text-center font-bold '>Mining</h1>
          ...
          {/* Dairy */}
          <section id="Oil" className=" border rounded shadow-lg m-5">
            <h1 className='text-4xl text-center font-bold '>Oil, Gas & Chemicals</h1>
